package com.example.android.my_bmi
...
import com.example.android.my_bmi.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnCalculate.setOnClickListener {
            ...
            val ft = binding.etHeight.text.toString().toDouble()
            val cm: Double = ft * 30.48

            val weight = binding.etWeight.text.toString()
            val height = cm.toString()
    ...
    private fun displayResult(bmi: Double){
        ...
        binding.btnCalculate.setBackgroundColor(ContextCompat.getColor(this, color))
